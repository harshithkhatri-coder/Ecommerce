    ...
    <div className="min-h-full bg-gradient-to-b from-black via-gray-900 to-gray-800 text-gray-200">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div>
            ...
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-2xl font-bold text-gray-300">Our Vision</h3>
              </div>
              <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-gray-800 rounded-lg shadow-lg p-8 mb-16">
          <h2 className="text-3xl font-bold text-center text-gray-300 mb-8">Why Choose Us?</h2>
            ...
            <div className="text-center">
              <a href="https://www.instagram.com/veluxkicks/" target="_blank" rel="noopener noreferrer" className="inline-block">
               ...
               <p className="text-gray-300 mb-2">Instagram</p>
                 <a href="https://www.instagram.com/veluxkicks/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition font-semibold">
                veluxkicks
              </a>
            </div>
          </div>
