...
export const productsData = [
  ...
  { id: 13, name: "Classic Analog Watch", price: 2499, image: imageArray[0], category: "Watches", reviews: [{ user: "Mike", rating: 5, comment: "Elegant and timeless.", images: [imageArray[1]] }] },
  { id: 14, name: "Smart Watch Pro", price: 5999, image: imageArray[2], category: "Watches", reviews: [{ user: "Sara", rating: 4, comment: "Great features and battery life.", images: [imageArray[3]] }] },
  { id: 15, name: "Leather Dress Belt", price: 899, image: imageArray[4], category: "Belts", reviews: [{ user: "Tom", rating: 5, comment: "Premium quality leather.", images: [] }] },
  { id: 16, name: "Casual Canvas Belt", price: 499, image: imageArray[6], category: "Belts", reviews: [{ user: "Amy", rating: 4, comment: "Perfect for casual wear.", images: [imageArray[8]] }] },
  { id: 17, name: "Sport Digital Watch", price: 1999, image: imageArray[8], category: "Watches", reviews: [{ user: "Chris", rating: 5, comment: "Perfect for workouts.", images: [imageArray[9]] }] },
  { id: 18, name: "Designer Belt", price: 1299, image: imageArray[10], category: "Belts", reviews: [{ user: "Lisa", rating: 4, comment: "Stylish and durable.", images: [] }] },
];
